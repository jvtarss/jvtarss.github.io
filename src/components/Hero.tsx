    ...
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className={`lg:col-span-7 space-y-8 ${isVisible ? 'animate-slide-up opacity-100' : 'opacity-0'}`} style={{ transitionDelay: '0.2s' }}>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-wrap gap-3">
                {skills.map((skill, index) => (
                  <div 
                    key={index} 
                    className="glass-card p-3 rounded-lg backdrop-blur-xl border border-white/10 animate-fade-in hover:border-bio-accent/50 hover:shadow-[0_0_15px_rgba(144,255,52,0.4)] transition-all duration-300" 
              ...
              <div className="tech-stack-container">
                ...
                <div className="flex flex-wrap gap-2">
                  <img 
                    ...
                    alt="React" 
                    className="w-12 h-12 animate-fade-in tech-icon hover:scale-110 hover:shadow-[0_0_10px_rgba(144,255,52,0.5)] transition-all duration-300" 
            ...
            <div className="flex space-x-4">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="social-icon backdrop-blur-xl border border-white/20 hover:border-bio-accent/50 hover:shadow-[0_0_15px_rgba(144,255,52,0.3)] transition-all duration-300"
                aria-label="GitHub"
              >
                <Github size={20} />
              </a>
          ...
          <div className={`lg:col-span-5 flex justify-center lg:justify-end ${isVisible ? 'animate-slide-in-right opacity-100' : 'opacity-0'}`} style={{ transitionDelay: '0.5s' }}>
            <div className="relative">
              ...
              <div className="relative glass-card rounded-2xl overflow-hidden h-[400px] w-[300px] md:h-[500px] md:w-[350px] animate-float backdrop-blur-xl border border-white/20 hover:border-bio-accent/30 hover:shadow-[0_0_20px_rgba(144,255,52,0.2)] transition-all duration-500">
                <div className="w-full h-full p-6 flex flex-col items-center justify-center gap-8">
                  <div className="w-full h-2/3 glass-card rounded-xl overflow-hidden relative hover:shadow-[0_0_15px_rgba(144,255,52,0.3)] transition-all duration-300">
      ...
      <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce">
        <Link
          ...
          duration={800}
          offset={-70}
          className="w-10 h-10 rounded-full glass-button flex items-center justify-center cursor-pointer backdrop-blur-xl border border-white/20 hover:border-bio-accent/30 hover:shadow-[0_0_15px_rgba(144,255,52,0.3)] transition-all duration-300"
        >
